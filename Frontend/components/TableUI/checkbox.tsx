...
>(({ className, ...props }, ref) => (
  <CheckboxPrimitive.Root
    ref={ref}
    className={`
      peer h-4 w-4 shrink-0 rounded-sm border border-slate-200
      ...
      disabled:opacity-50 bg-slate-100 data-[state=unchecked]:bg-slate-100
      data-[state=checked]:bg-[#55DE72]
